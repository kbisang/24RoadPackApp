...
-(void)sendGetRequest:(NSString*)urlString
    ...
    NSURL* url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/%@"
                  , [SettingsModel sharedSettings].urlAssistanceServer, urlString]];
                    ...
                    completion:(void (^)(NSArray *))requestCompleted
{
    ...
    RKObjectManager* manager = [RKObjectManager
                managerWithBaseURL:[NSURL
                    URLWithString:[SettingsModel sharedSettings].urlAssistanceServer]];
            ...
            completion:(void (^)(NSArray *))requestCompleted
{
    ...
    RKObjectManager* manager = [RKObjectManager
        managerWithBaseURL:[NSURL URLWithString:[SettingsModel sharedSettings].urlAssistanceServer]];
